...
var _stockDataJs = require('./stockData.js');

var _stockDataJs2 = _interopRequireDefault(_stockDataJs);
...
var mapData = function mapData(items) {
	return _underscore2['default'].map(items, function (item) {
		return { 'value': item.value, 'date': parseDate(item.date) };
	});
};
var stockData = [mapData(_stockDataJs2['default'].AAPL), mapData(_stockDataJs2['default'].AMZN), mapData(_stockDataJs2['default'].IBM)];
...
},{"./stockData.js":2,"./treeData.js":3,"react":undefined,"react-pathjs-chart":undefined,"underscore":undefined}],2:[function(require,module,exports){
"use strict";
